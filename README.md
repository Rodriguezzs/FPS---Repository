...
```bash
curl -sSL [https://raw.githubusercontent.com/Rodriguezzs/FPS---Repository/main/scripts/instalar.sh](https://raw.githubusercontent.com/Rodriguezzs/FPS---Repository/main/scripts/instalar.sh) | sh
